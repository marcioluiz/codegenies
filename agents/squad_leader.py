...
class SquadLeader(BaseAgent):
    ...
    def generate_general_report(self, analyst_report):
        ...
        """
        prompt = f"{analyst_report}\n\n{self.prompts.get_general_report_instructions(self.language)}"
    ...
    def generate_backend_backlog(self, analyst_report, general_report):
        """
        ...
        Args:
            - analyst_report (str): Initial report generated by the analyst.
        """
        prompt = f"{self.prompts.get_backend_backlog_model(self.language)}\n\n{analyst_report}\n\n{general_report}\n\n{self.prompts.get_backend_instructions(self.language)}"
        response = self.evaluate(prompt)
        if self.interactive:
            final_response = self.interact(response)
        else:
    ...
    def generate_frontend_backlog(self, analyst_report):
        ...
        Args:
            - analyst_report (str): Initial report generated by the analyst.
        """
        prompt = f"{self.prompts.get_frontend_backlog_model(self.language)}\n\n{analyst_report}\n\n{self.prompts.get_frontend_instructions(self.language)}"
        response = self.evaluate(prompt)
        if self.interactive:
            final_response = self.interact(response)
        else:
    ...
    def generate_test_backlog(self, analyst_report, general_report):
        """
        ...
        Args:
            - analyst_report (str): Initial report generated by the analyst.
        """
        prompt = f"{self.prompts.get_tests_backlog_model(self.language)}\n\n{analyst_report}\n\n{general_report}\n\n{self.prompts.get_tests_instructions(self.language)}"
        response = self.evaluate(prompt)
        if self.interactive:
            final_response = self.interact(response)
        else:
