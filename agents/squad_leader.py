...
from .prompt_templates import SquadLeaderPrompts as prompt_templates
...
class SquadLeader(BaseAgent):
    ...
    def generate_general_report(self, analyst_report):
        ...
        """
        prompt = f"{analyst_report}\n\n{prompt_templates.general_report_instructions}"
    ...
    def generate_backend_backlog(self, analyst_report):
        ...
        Args:
            - analyst_report (str): Initial report generated by the analyst.
        """
        prompt = f"{prompt_templates.backend_backlog_model}\n\n{analyst_report}\n\n{prompt_templates.backend_instructions}"
        response = self.evaluate(prompt)
        if self.interactive:
            final_response = self.interact(response)
        else:
    ...
    def generate_frontend_backlog(self, analyst_report):
        ...
        Args:
            - analyst_report (str): Initial report generated by the analyst.
        """
        prompt = f"{prompt_templates.frontend_backlog_model}\n\n{analyst_report}\n\n{prompt_templates.frontend_instructions}"
        response = self.evaluate(prompt)
        if self.interactive:
            final_response = self.interact(response)
        else:
    ...
    def generate_test_backlog(self, analyst_report):
        ...
        Args:
            - analyst_report (str): Initial report generated by the analyst.
        """
        prompt = f"{prompt_templates.tests_backlog_model}\n\n{analyst_report}\n\n{prompt_templates.tests_instructions}"
        response = self.evaluate(prompt)
        if self.interactive:
            final_response = self.interact(response)
        else:
